...
/** I2C Device Address 8 bit format  if SA0=0 -> 6A becomes D4 if SA0=1 -> 6B becomes D6**/
#define LSM6DSR_I2C_ADD_L                    0xD4U
#define LSM6DSR_I2C_ADD_H                    0xD6U
